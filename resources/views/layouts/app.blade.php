            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1">
                        ...
                        <ul class="space-y-2">
                            <li><a href="https://github.com/rian1504/NutriMPASI-Mobile" class="hover:underline">GitHub Mobile</a></li>
                            <li><a href="https://github.com/rian1504/NutriMPASI-Web" class="hover:underline">GitHub Web</a></li>
                            <li><a href="#" class="hover:underline">Demo Video</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="flex space-x-3 mt-4">
                            <a href="mailto:nutrimpasi@gmail.com" class="bg-white rounded-full p-2 hover:bg-white/80">
                                <svg class="w-5 h-5 text-[#F59E0B]" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                                </svg>
                            </a>
                            <a href="https://instagram.com/nutrimpasi" class="bg-white rounded-full p-2 hover:bg-white/80">
                                <svg class="w-5 h-5 text-[#F59E0B]" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
