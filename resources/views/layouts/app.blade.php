        ...
        <nav class="bg-white shadow-navbar py-4 fixed top-0 left-0 right-0 w-full z-50">
            <div class="container mx-auto px-4 flex justify-between items-center">
                <a href="#top" class="flex items-center">
                    ...
                    <span class="text-2xl font-extrabold ml-2"><span class="text-[#5966B1]">Nutri</span><span
                            class="text-[#F59E0B]">MPASI</span></span>
                </a>
                <div class="hidden md:flex space-x-8">
                    <a href="#top" class="nav-link text-gray-700 hover:text-[#F59E0B] text-lg font-medium"
                        data-section="top">Beranda</a>
                    <a href="#produk" class="nav-link text-gray-700 hover:text-[#F59E0B] text-lg font-medium"
                        data-section="produk">Produk</a>
                    <a href="#fitur" class="nav-link text-gray-700 hover:text-[#F59E0B] text-lg font-medium"
                        data-section="fitur">Fitur</a>
                    <a href="#tentang-kami" class="nav-link text-gray-700 hover:text-[#F59E0B] text-lg font-medium"
                        data-section="tentang-kami">Tentang Kami</a>
                    <a href="#kontak" class="nav-link text-gray-700 hover:text-[#F59E0B] text-lg font-medium"
            ...
            <div id="mobile-menu" class="md:hidden bg-white absolute w-full left-0 top-full z-20 shadow-lg hidden">
                <div class="py-2 px-4 space-y-3">
                    <a href="#top"
                        class="mobile-nav-link block py-2 px-4 text-gray-700 hover:text-[#F59E0B] hover:bg-gray-50 font-medium hover:border-l-4 hover:border-[#F59E0B]"
                        data-section="top">Beranda</a>
                    <a href="#produk"
                        class="mobile-nav-link block py-2 px-4 text-gray-700 hover:text-[#F59E0B] hover:bg-gray-50 font-medium hover:border-l-4 hover:border-[#F59E0B]"
                        data-section="produk">Produk</a>
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1">
                        <div class="flex items-center mb-4">
                            <div class="bg-white p-2 rounded-full mr-3">
                                <img src="{{ asset('image/logo/navbar_logo.png') }}" alt="NutriMPASI Logo"
                                    class="h-9">
                            </div>
                            <span class="text-2xl font-extrabold">NutriMPASI</span>
                        </div>
                        <p class="text-white/90 text-sm mt-3">
                            NutriMPASI merupakan aplikasi mobile berbasis AI yang dirancang untuk membantu orang tua
                            menyusun MPASI yang sesuai kebutuhan gizi bayi secara mudah dan tepat.
                        </p>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <ul class="space-y-2">
                            <li><a href="https://youtu.be/99fju-8Rmbg" target="_blank" rel="noopener noreferrer"
                                    class="hover:underline">Demo Video</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="flex space-x-3 mt-4">
                            <a href="mailto:nutrimpasi@gmail.com" target="_blank" rel="noopener noreferrer"
                                class="bg-white rounded-full p-2 hover:bg-white/80">
                                <svg class="w-5 h-5 text-[#F59E0B]" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                                </svg>
                            </a>
                            <a href="https://instagram.com/nutrimpasi" target="_blank" rel="noopener noreferrer"
                                class="bg-white rounded-full p-2 hover:bg-white/80">
                                <svg class="w-5 h-5 text-[#F59E0B]" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
