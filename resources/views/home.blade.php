        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-1/2 mb-10 md:mb-0" data-aos="fade-right" data-aos-delay="100">
                    ...
                    <a href="#" target="_blank" rel="noopener noreferrer" class="inline-block transform hover:scale-105 transition-transform duration-200">
                ...
                <div class="w-full md:w-1/2" data-aos="zoom-in" data-aos-delay="200">
                    <div class="bg-[#5966B1] rounded-xl p-6 relative flex flex-col md:flex-row items-center max-w-md ml-auto">
                        <div class="w-full md:w-2/3 mb-6 md:mb-0 md:mr-6">
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer" class="bg-[#F59E0B] text-white px-8 py-3 rounded-full font-medium hover:bg-[#E59009] transition-all inline-block">
                                Download App
                            </a>
                        ...
                        <div class="absolute -bottom-5 -right-5">
                            <div class="relative bg-[#242A41] rounded-full w-20 h-20 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('image/icons/android_icon.png') }}" alt="Android" class="w-10 h-10 absolute">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="md:pl-10">
                        ...
                        <div class="flex mb-8" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-justify">Mampu merekomendasikan makanan dan menghitung nutrisi otomatis sesuai kebutuhan spesifik bayi.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-justify">Fitur interaktif, menu, jadwal masak, hingga resep lengkap dan riwayat gizi semua dalam satu aplikasi.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg relative" data-aos="flip-left" data-aos-delay="100">
                    ...
                    <div class="p-8 text-center relative z-10">
                        ...
                        <p class="text-gray-600 text-center mb-6">
                            Fitur yang memungkinkan pengguna menambahkan, mengubah, atau menghapus resep MPASI untuk diusulkan ke dalam daftar makanan aplikasi sesuai kebutuhan nutrisi bayi.
                        </p>
                    </div>
                    <div class="bg-gray-50 px-4 relative z-10">
                        <img src="{{ asset('image/mockups/food_list_mockup.png') }}" alt="Fitur Resep Usulan" class="w-full">
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg relative" data-aos="flip-up" data-aos-delay="200">
                    ...
                    <div class="p-8 text-center relative z-10">
                        <p class="text-gray-600 text-center mb-4">
                            Fitur berbasis AI yang menghitung kandungan nutrisi dari bahan makanan yang diusulkan pengguna secara otomatis.
                        </p>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg relative" data-aos="flip-right" data-aos-delay="300">
                    ...
                    <div class="p-8 text-center relative z-10">
                        ...
                        <p class="text-gray-600 text-center mb-6">
                            Fitur untuk mencatat dan membandingkan total energi menu MPASI dalam rentang waktu tertentu guna memantau kecukupan gizi demi pertumbuhan optimal bayi.
                        </p>
                    </div>
                    <div class="bg-gray-50 px-4 relative z-10">
                        <img src="{{ asset('image/mockups/cooking_history_mockup.png') }}" alt="Fitur Riwayat Memasak" class="w-full">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="absolute bottom-0 left-0 w-full px-4 py-3 bg-gradient-to-t from-black/70 to-transparent">
                            <div class="flex items-center">
                                ...
                                <button class="text-white mr-4">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15.536a5 5 0 001.414-9.9m-3.737 12.728a9 9 0 0112.728-12.728"></path>
                                    </svg>
                                </button>
                                
                                <div class="w-full bg-gray-500 rounded-full h-1">
                                    <div class="bg-[#F59E0B] h-1 rounded-full w-1/3 relative">
                                        <div class="absolute -top-1.5 right-0 w-3 h-3 bg-white rounded-full border-2 border-[#F59E0B]"></div>
                                    </div>
                                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-4 text-center">
                        ...
                        <div class="mt-4 flex justify-center space-x-4">
                            <a href="https://www.instagram.com/tikha12" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]">
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]">
                                <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.linkedin.com/in/sartikha/" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]">
                                <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="p-3 text-center">
                        ...
                        <div class="mt-3 flex justify-center space-x-3">
                            <a href="https://www.instagram.com/leaantony17" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
                            <a href="https://github.com/leaantony" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg></a>
                            <a href="https://www.linkedin.com/in/lea-antony/" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                </svg></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="p-3 text-center">
                        ...
                        <div class="mt-3 flex justify-center space-x-3">
                            <a href="https://www.instagram.com/pipitlol" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
                            <a href="https://github.com/pipitlol" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg></a>
                            <a href="https://www.linkedin.com/in/pipitlolita/" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="p-3 text-center">
                        <p class="text-gray-700">Frontend Developer</p>
                        <div class="mt-3 flex justify-center space-x-3">
                            <a href="https://www.instagram.com/firmxn" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
                            <a href="https://github.com/firmxn" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg></a>
                            <a href="https://www.linkedin.com/in/firmxn/" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-[#F59E0B]"><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="w-full md:w-3/5 pl-2 sm:pl-4">
                            ...
                            <div class="flex items-center mt-4 sm:mt-6">
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white mr-2 sm:mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                                </svg>
